  ...
  const groups: Group[] = [
    {
      ...
      memberCount: 4,
      balance: -45.50,
      lastActivity: "John added expense: Hotel Booking",
      members: [
        { id: 1, name: "John Doe", avatar: "/api/placeholder/32/32", paid: 500, owed: 312.50 },
        { id: 2, name: "Jane Smith", avatar: "/api/placeholder/32/32", paid: 300, owed: 312.50 },
        { id: 3, name: "Mike Johnson", avatar: "/api/placeholder/32/32", paid: 450, owed: 312.50 },
        { id: 4, name: "Sarah Wilson", avatar: "/api/placeholder/32/32", paid: 0, owed: 312.50 }
      ],
      expenses: [
        { id: 1, date: "2024-01-19", description: "Hotel Booking", amount: 800, paidBy: "John Doe", splitMethod: "Equal" },
        { id: 2, date: "2024-01-18", description: "Dinner", amount: 120, paidBy: "Jane Smith", splitMethod: "Equal" }
      ]
    },
    {
        id: 1,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {groups.map((group) => (
                ...
                className={`cursor-pointer transition-all hover:shadow-md ${
                    selectedGroup?.id === group.id ? 'ring-2 ring-emerald-500' : ''
                }`}
